...
public class LBACO{
	...
	public Map<Integer,Integer> implement(List<Cloudlet> taskList,List<Vm> vmList) throws FileNotFoundException{
	...
	public LBACO(int m, double Q, double alpha, double beta, double gamma, double rho, int tmax){
		this.m = m;
		this.Q = Q;
		this.alpha = alpha;
		this.beta = beta;
